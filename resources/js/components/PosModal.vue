...
<div class="modal fade" id="posModal" tabindex="-1" role="dialog">
  <form @submit.prevent="submit" class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row form-group">
          ...
          <div class="col">
            <select v-model="sale.payment_method_id" class="custom-select" required>
              ...
              <option v-for="item in paymentMethods" :value="item.id" :key="item.id">{{ item.name }}</option>
            </select>
          </div>
        </div>
        <div class="row form-group">
        ...
        <div class="row form-group">
          ...
          <div class="col">
            <input type="text" v-model="customer.document" maxlength="8" class="form-control" placeholder="DNI del cliente" required>
          </div>
        </div>
        <div class="row form-group">
          <label for="" class="col-form-label col-md-3">
