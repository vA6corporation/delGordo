        ...
        <div class="card-body">
          <div class="row form-group">
            <div class="col">
              ...
              <input type="text" v-model="subCategory.name" class="form-control" placeholder="Nombre" required>
            </div>
          </div>
          <!-- <div class="row form-group">
            <div class="col">
              <label for="">Categoria</label>
              <select class="custom-select" v-model="product.subCategory" required>
          ...
          <div class="row form-group">
            <div class="col">
              ...
              <select class="custom-select" v-model="product.sub_subCategory" required>
...
export default {
  ...
  methods: {
    fetchData() {
      var subCategoryId = this.$route.params.subCategoryId;
      axios.get(`subCategories/${subCategoryId}`).then(res => {
        console.log(res);
        this.subCategory = res.data.subCategory;
      });
    },
    submit() {
      axios.put(`subCategories/${this.subCategory.id}`, { subCategory: this.subCategory }).then(res => {
