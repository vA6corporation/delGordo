<template>
  <div class="row">
    ...
    <deliveryman-modal :sale='sale' @confirm='fetchData'/>
    <div class="col">
      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex justify-content-between">
            <h3 class="card-title mb-0">Despacho</h3>
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="item in sales" :key='item.id'>
                ...
                <td v-else>No</td>
                <td v-if='item.deliveryman'>{{ item.deliveryman.name }}</td>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      axios.get('sales/dispatchedSales', { params }).then(res => {
        console.log(res);
        this.sales = res.data.sales;
