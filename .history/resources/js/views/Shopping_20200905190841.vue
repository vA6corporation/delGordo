    ...
    <table class='table' style="background-color: white; margin-top: 5vh;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Vino  Domaine de la Romanée-Conti &nbsp;&nbsp; <img style="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/vinos-mas-caros-del-mundo-screaming-eagle-1560258957.jpg?resize=480:*" alt=""></td>
                <td>2 BOT</td>
                <!--<td>BOT</td>-->
                <td>
                  <button type="button" class="btn btn-sm btn-secondary">
