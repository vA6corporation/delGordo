    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">  
            <div class="row" style="background-color: rgb(245, 166, 35)!important;  width: 100%;">
                <div type="button" class="btn" styke="color:white; background-color:rgb(245, 166, 35)!important;" data-dismiss="modal">Pagar</div>
            </div>
            <div class="row">
                <img src="/assets/images/pay.jpg" style="width: 50%;">
            </div>    
    </div>
      </div>
