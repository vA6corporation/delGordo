        ...
        <form>
            <div class="form-row">
                ...
                <div class="col-5">
                    ...
                    <input id="card_number" type="text" class="form-control" placeholder="4557 8808 1234 56789">
                </div>
            </div>
            <div class="form-row">
                <div class="col-3">
                ...
                <div class="col-3">
                    ...
                    <input id="card_year" type="text" class="form-control" placeholder="4557 8808 1234 56789">
                </div>
            </div>
        </form>
        </div>
