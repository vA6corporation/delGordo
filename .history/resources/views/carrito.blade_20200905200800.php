<section id="carrito">
  ...
  <!-- Modal -->
  <div class="modal fade" id="myModal" role="dialog" style="margin-top5">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">  
            <div class="row btn" style="background-color: rgb(245, 166, 35)!important;  width: 100%;">
                <div type="button" class="btn" styke="color:white; background-color:rgb(245, 166, 35)!important;">
                    <h5>Pagar</h5>
                </div>
            </div>
            <div class="row" style="justify-content: center; display:flex">
                <img src="/assets/images/pay.jpg" style="width: 60%;">
            </div>    
    </div>
      </div>
